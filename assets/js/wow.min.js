(function () {
    ...
    e = function () {
    ...
    }(), n = this.WeakMap || this.MozWeakMap, t = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver, this.WOW = function () {
        function r(t) {
        ...
        return r.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function () {
                ...
                return o
            }.call(this), this.boxes.length) for (n = 0, i = (o = this.boxes).length; i > n; n++) e = o[n], this.applyStyle(e, !0);
            return window.addEventListener("scroll", this.scrollHandler, !1), window.addEventListener("resize", this.scrollHandler, !1), this.interval = setInterval(this.scrollCallback, 50), this.config.live ? new t(function (t) {
                return function (e) {
                    var n, i, o, r, s;
