!function (b, a) {
    ...
    return function (b) {
        ...
        }(), f = b(1), g = b(3), d = function () {
            function a(b, c) {
                (function (a, b) {
                    if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function")
                })(this, a), f.initializer.load(this, c, b), this.begin()
            }
                ...
                key: "typewrite", value: function (a, b) {
                    ...
                    return !0 === this.pause.status ? void this.setPauseStatus(a, b, !0) : void (this.timeout = setTimeout(function () {
                        ...
                        if ("^" === c.charAt(0) && /^\^\d+/.test(c)) {
                            var h = 1;
                            h += (c = /\d+/.exec(c)[0]).length, f = parseInt(c), d.temporaryPause = !0, d.options.onTypingPaused(d.arrayPos, d), a = a.substring(0, b) + a.substring(b + h), d.toggleBlinking(!0)
                        }
                        if ("`" === c.charAt(0)) {
        ...
        "use strict";
        var a, g = Object.assign || function (d) {
        ...
        }(), i = (a = d(2)) && a.__esModule ? a : {default: a}, c = function () {
            function a() {
                !function (a, b) {
                    if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function")
                }(this, a)
